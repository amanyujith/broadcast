  ...
  return (
    <div className="app flex flex-col lg:flex-row relative bg-[#fff] font-sans min-h-screen overflow-hidden z-[1]">
      <div className="left-section relative w-full lg:w-[47%] z-[2] flex justify-center lg:justify-start">
        <img
          className="profile-img w-[200px] lg:w-[350px] object-cover absolute z-[100] left-[80%]  lg:left-[80px] top-[100px] lg:top-[100px] transform -translate-x-1/2 lg:translate-x-0 border-[5px] border-solid border-white"
          src={teamMember.image}
          alt={`${teamMember.name} profile`}
        />
        <div className="purple-background z-[3]">
          <h1 className="text-white text-center lg:text-left relative left-0 lg:left-[300px] top-[-50px] text-2xl lg:text-[2.5rem] mb-[50px]">Meet <br /> Our Team</h1>
        </div>
      </div>
