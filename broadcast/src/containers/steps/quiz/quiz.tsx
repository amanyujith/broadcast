        ...
        >
          ...
          <div className="flex justify-center mt-20">
            <div className="bg-[#FFAD60] w-40 h-40 rounded-full flex  flex-col justify-center items-center">
                <div className="bg-[#D3EE98]  w-[150px] h-[75px]  rounded-t-full border-r-2 border-l-2 border-[#D3EE98] flex flex-col justify-between items-center">
                    <p className="mt-5">SCORE</p>
                    {/* <div className="bg-[#FEFF9F] w-[75px] h-[30px] rounded-t-full  mr-[75px]"></div> */}
                    
                </div>
               
                <div className=" bg-[#FEFF9F] w-[150px] h-[75px] rounded-b-full border-r-2 border-l-2 border-[#FEFF9F] flex flex-col justify-center items-center ">
                {/* <div className="bg-[#D3EE98] w-[75px] h-[30px] rounded-b-full  ml-[75px]"></div> */}
                <p className="">{score}</p>
                </div>
            </div>
          </div>
